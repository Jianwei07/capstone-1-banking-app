  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography variant="h2" align="left" color="white">
            Evolve your wallet efficiency with InnovPay competitive exchange
            rates and Interest API
          </Typography>
      ...
      <Grid
        ...
        rowSpacing={1}
        columnSpacing={{ xs: 1, sm: 2, md: 3 }}
        sx={{ backgroundColor: "#152840", justifyContent: "center" }}
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" paragraph color="pink">
            ...
            Wallet, protecting your assets and transactions with advanced
            encryption and robust security measures.
          </Typography>
        </Grid>
        <Grid
          item
        ...
        >
          ...
          <Typography variant="body1" paragraph color="pink">
            ...
            lightning-fast remittances, simplifying international transactions.
          </Typography>
        </Grid>
        <Grid
          item
