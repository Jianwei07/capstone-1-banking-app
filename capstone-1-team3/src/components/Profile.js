...
export function Profile(props) {
  ...
  const handleInput = (e) => {
    ...
    setInputProfile({
      ...inputProfile,
      profile: { ...inputProfile.profile, [e.target.name]: e.target.value },
    });
  };
      ...
      <form className="profile-form" onSubmit={handleSubmit}>
        ...
        <div className="name-group">
          <div className="profile-field">
            ...
            <input
              type="text"
              name="fName"
              value={inputProfile.profile.fName}
          ...
          <div className="profile-field">
            ...
            <input
              type="text"
              name="lName"
              value={inputProfile.profile.lName}
              onChange={(e) => handleInput(e)}
            />
          </div>
        </div>
        <div className="profile-field">
          ...
          <input
            type="text"
            name="nRIC"
            value={inputProfile.profile.nRIC}
            onChange={(e) => handleInput(e)}
          />
        </div>
        <div className="profile-field">
          ...
          <input
            type="text"
            name="address"
            value={inputProfile.profile.address}
            onChange={(e) => handleInput(e)}
          />
        </div>
        <div className="profile-field">
